      ...
      <ScreenWrapper>
          <View className="h-full flex justify-around">
              ...
              <View className="flex mr-5 ml-5">
                  <Text className={` font-normal text-[23px] `}>Mot de passe oublié</Text>
              ...
              <View className="space-y-2 mx-4">
                  ...
                  <View className="flex-row items-center bg-white rounded-full p-3">
                      ...
                      <TextInput className="ml-2 flex-1" placeholder="Email" />
                  </View>
              </View> 
              ...
              <View className="mx-5 mb-1">
                  ...
                  >
                      <Text className="text-center font-bold text-white text-lg">Envoyer</Text>
                  </TouchableOpacity>
